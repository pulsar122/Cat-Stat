...
#define CATVER 1											  /* 0 - 1.21, 1 - >=1.3nû 						*/

#if (CATVER==1)
	#define VERSION "Version 1.32 fÅr 2.x- & 5.x-Datenbanken"
	#define CAT2xx	1
	#define	CAT5xx	2
#else
	#define VERSION "Version 1.32 fÅr 1.21-Datenbank"
#endif
...
*/
				...
				if(*outname)
				{
					...
					CACHEDAT(msgstart);
					DORTWDAT(anzeint,msgstart);					/* Anzahl der EintrÑge holen	*/
